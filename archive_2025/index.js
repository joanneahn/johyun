  ...
  var arr = [
    {
        ...
        title: "데이터 활용기획",
        url: "cube/lab.html",
        bold: "데이터 3법으로 인해 증폭된 데이터 서비스 연계, 분석 등을 활용하여 맞춤형 임상심리검사서비스가 어떻게 뻗어나갈 수 있을까",
    ...
    },
    {
      ...
      title: "개인정보 로드맵",
      url: "01-1.html",
      bold: "유저 개인정보 수집, 이용, 보관, 파기 절차:",
      light: "합법적 개인정보 수집 및 처리 절차"
    },
    {
        num: "04",
        title: "데이터 활용기획",
    ...
    },
    {
      ...
      url: "cube/works.html",
      bold: "중요정보 전송시 설계 내용:",
      light: "보안기능 프로그램 동작을 위한 처리방법 (암호키 관리, 2단계 인증 등)"
    },
    {
      num: "05",
      title: "보안담당자 Dashboard",
      url: "cube/",
    ...
    },
    {
      ...
      bold: "PSEMO 홈페이지 웹 개발자용 개인정보보안 메뉴얼:",
      light: "안전한 정보보안을 위해 세모 웹사이트 개발자가 적용할 기능 및 점검할 내용"
    }
  ]
